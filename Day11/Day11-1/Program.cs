...
}
{
    ...
    {
        Name = "Monkey 2",
        Items = new List<int> { 61, 81, 84, 69, 77, 88 },
        Operation = Operation.Multiply,
        OperationFactor = 19,
        TestFactor = 5
    });
    ...
    {
        Name = "Monkey 3",
        Items = new List<int> { 78, 89, 71, 60, 81, 84, 87, 75 },
        Operation = Operation.Addition,
        OperationFactor = 7,
        TestFactor = 3
    });
    ...
    {
        Name = "Monkey 4",
        Items = new List<int> { 60, 76, 90, 63, 86, 87, 89 },
        Operation = Operation.Addition,
        OperationFactor = 2,
        TestFactor = 13
    });
    ...
    {
        Name = "Monkey 6",
        Items = new List<int> { 84, 98, 78, 85 },
        Operation = Operation.MultiplyOld,
        TestFactor = 7
    });
    monkeys.Add(new Monkey()
    {
        Name = "Monkey 7",
        Items = new List<int> { 98, 89, 78, 73, 71 },
        Operation = Operation.Addition,
        OperationFactor = 4,
        TestFactor = 2
    });
...
{
    internal int Inspections = 0;
    internal string Name;
    internal List<int> Items = new List<int>();
    internal Operation Operation;
    internal int OperationFactor;
    internal int TestFactor;
