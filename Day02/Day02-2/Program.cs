...
internal struct Round
{
    ...
    public int Outcome()
    {
        if (ElfMove == 'A') //Rock
        {
            if (YourMove == 'X') return Loss + Scissors;
            if (YourMove == 'Y') return Tie + Rock;
            if (YourMove == 'Z') return Win + Paper;
        }
        ...
        {
            if (YourMove == 'X') return Loss + Paper;
            if (YourMove == 'Y') return Tie + Scissors;
            if (YourMove == 'Z') return Win + Rock;
        }
